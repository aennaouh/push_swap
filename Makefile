...
#    Updated: 2023/04/04 11:38:00 by aennaouh         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =  mandatory/instraction.c  mandatory/push_utilise.c  mandatory/instraction2.c  mandatory/push_utilise2.c   mandatory/push_utilise1.c  mandatory/suite_sort_num_500.c\
 mandatory/linked_list.c  mandatory/sort_numbers.c   mandatory/instraction3.c  mandatory/test.c  mandatory/sort_number100.c \
...
bonus/push_utilise3.c bonus/suite_mian.c \
